...
/**
 * One selected Spoken Key value for a DBM work order.
 */
@Entity
@Table(
        name = "dbm_work_order_spoken_keys",
        uniqueConstraints = @UniqueConstraint(
                name = "uq_dbm_spoken_keys_case_value",
                columnNames = {"case_id", "spoken_key"}
        )
)
public class DbmWorkOrderSpokenKey {
    ...
    @Column(name = "spoken_key", nullable = false, length = 64)
    ...
    public boolean equals(Object o) {
        ...
        DbmWorkOrderSpokenKey other = (DbmWorkOrderSpokenKey) o;
